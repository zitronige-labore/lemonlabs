...
// form data is imported here so it can be called in the page when the function is called
export function useSaveForm(
    basisData: any,
    additionalData: any,
    redFlags: any,
    selectedMainRegion: any,
    ...
    const handleSaveForm = async () => {
        // manual calling of saveFormData on click since the whole page is client side
        // and saveFormData cannot be called with the action attribute
